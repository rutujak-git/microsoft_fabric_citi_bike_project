...
BEGIN
    ...
    USING (
        SELECT
            ...
            rt.rider_type_key,
            CAST(b.started_at AS DATE) AS trip_date,
            DATEPART(HOUR, b.started_at) AS start_hour,
            ROUND(DATEDIFF(SECOND, b.started_at, b.ended_at) / 60.0, 2) AS trip_duration_minutes,
            gold.fn_classify_trip_duration(
                ROUND(DATEDIFF(SECOND, b.started_at, b.ended_at) / 60.0, 2)
